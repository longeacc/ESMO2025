"""
GLiNER fine-tuning + evaluation on MACCROBAT2020.
...
Pipeline:
  ...
  4. Save results to gliner_results.csv, params to gliner_train_params.csv

Labels passed at inference = exact strings used during training
...
def eval_model(model, docs: list[dict], threshold: float) -> tuple:
    ...
    for doc in docs:
        ...
        raw = model.predict_entities(text, MACCROBAT_LABELS, threshold=threshold)
